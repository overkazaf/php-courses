...
<body style=" background-image:url(img/338856.jpg); background-repeat:no-repeat; background-size:cover">
...
?>
  ...
  ?>
          <tbody>
              <tr>
                <td><font color="#FFF"><?php echo $row1['level_2_name'] ?></font></td>
                <td><font color="#FFF"><?php echo $row1['comments_count'] ?></font></td>
...
?>
           <li><a href="paihang.php?page2=<?php echo $page2 - 1;?>">Previous</a></li>
                     <?php
}
  for ($i=1;$i<=$totalPage;$i++) {  
  //循环显示出页面
...
?>
           <li><a href="paihang.php?page2=<?php echo $page2 + 1;?>">Next</a></li>
                      <?php
} 
?>
         </ul>
