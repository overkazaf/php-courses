   ...
   <div class="collapse navbar-collapse" id="example-navbar-collapse">
	...
	$result=mysqli_query($conn,$sql);?>
        	<table class="table">
              ...
              <tbody>
              	<tr>
         		<td style="width:50%;"><a href="./keit.php"><font style="color:#FFF"><?php echo $row['user_name'] ?></font></a></td>
              ...
              <?php } ?>
                   ...
                   <ul class="pager">
         <?php if ($page != 0) { //页数不等于1
		 if($page > 2){
?>
 			<li class="previous"><a href="keit2.php?p=<?php echo $page - 1;?>">&larr; Older</a></li>
            <?php
		 }else 
 		 {?>
				 <li class="previous"><a href="<?php echo "./keit.php?new=".$cid ?>">&larr; Older</a></li>
		<?php	
		 }
...
?>
  			<li class="next"><a href="keit2.php?p=<?php echo $page + 1;?>">Newer &rarr;</a></li>
             <?php
} 
?>
		</ul>
    ...
    <div class="contain-fluid" style="float:left">
    	<div class="row">
        	<div class="panel panel-defau">
            	<div class="panel-body">
                课程目录<br>
                <?php var_dump(json_decode($row1['course_plan'],true))?>
                </div>
            </div>
        </div>
    </div>
